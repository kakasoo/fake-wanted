...
[![GitHub license](https://img.shields.io/badge/license-MIT-blue.svg)](https://github.com/kakasoo/fake-wanted/tree/master/LICENSE)
[![Build Status](https://github.com/kakasoo/fake-wanted/workflows/build/badge.svg)](https://github.com/kakasoo/fake-wanted/actions?query=workflow%3Abuild)
...
| https://github.com/kakasoo/fake-wanted | Your repository URL
...
Also as you can see from the [package.json](package.json) file, this project requires the private npm module `@kakasoo`, provided from the Github. Therefore, to develop this backend server, you've configure the `.npmrc` file. Open the below link and complete the configuration.
...
```bash
# CLONE REPOSITORY
git clone https://github.com/kakasoo/fake-wanted
cd backend
...
[`@samchon/backend`](https://github.com/kakasoo/fake-wanted) provides SDK (Software Development Kit) for convenience.
...
For reference, if you run `npm run benchmark` command, your test functions defined in the `test/features/api` directory would be utilized for performance benchmarking. If you want to see the performance bench result earlier, visit below link please:
  ...
  - [docs/benchmarks/AMD Ryzen 9 7940HS w Radeon 780M Graphics.md](https://github.com/kakasoo/fake-wanted/blob/master/docs/benchmarks/AMD%20Ryzen%209%207940HS%20w%20Radeon%20780M%20Graphics.md)
...
### 4.2. Directories
  ...
  - [src/](src/): TypeScript Source directory
    - [src/api/](src/api/): Client SDK that would be published to the `@kakasoo/fake-wanted-api`
