  ...
  (n.isNull = (r) => r.type === "null"),
    ...
    (n.visit = (r) => {
      const f = /* @__PURE__ */ new Set(),
        m = r.refAccessor ?? `$input.${st.reference(r.prefix)}`,
        b = (p, g) => {
          var v;
  ...
  const e = (r) => {
    ...
    t = (r) => {
      ...
      if (n.isReference(r.schema)) {
        ...
        const b = r.schema.oneOf.map((g, v) =>
          t({
            ...r,
            schema: g,
        ...
        return p.some(([v, O]) => O === null) || g === null
          ...
          : p.some(([v, O]) => {
            ...
            : {
                ...
                required:
                  ((m = b.required) == null ? void 0 : m.filter((v) => p.some(([O, x]) => O === v && x !== void 0))) ??
                  [],
              };
...
(function (n) {
  ...
  (n.downgradeComponents = (a) => {
    ...
    (n.downgradeSchema = (a) => (l) => {
      const d = _(/* @__PURE__ */ new Set())(a.original)(l),
        i = [],
        u = {
          title: l.title,
      ...
      if ((r(l), f(l), d === !0))
        for (const m of i) w.isReference(m) ? y(/* @__PURE__ */ new Set())(a)(m) : (m.nullable = !0);
          ...
          ? Object.fromEntries(
              Object.entries(d.headers)
                ...
                .map(([r, f]) => [
                  ...
                  (() => {
                    var b, p;
                    if (a.isReference(f) === !1)
                      return s(l.components ?? {})({
                        ...f,
                        in: "header",
                      });
                ...
                ? Object.fromEntries(
                    Object.entries(u.examples)
                      .map(([r, f]) => {
                        ...
                        return [
                          r,
                          a.isReference(f) ? ((m = l.examples) == null ? void 0 : m[f.$ref.split("/").pop() ?? ""]) : f,
                        ];
                      })
                      .filter(([r, f]) => f !== void 0),
                  )
          ...
          ? Object.fromEntries(
              Object.entries(r.headers)
                ...
                .map(([b, p]) => [
                  ...
                  (() => {
                    var v, O;
                    if (i.isReference(p) === !1)
                      return c(u.components ?? {})({
                        ...p,
                        in: "header",
                      });
                ...
                ? Object.fromEntries(
                    Object.entries(m.examples)
                      .map(([b, p]) => {
                        ...
                        return [
                          b,
                          i.isReference(p) ? ((g = u.examples) == null ? void 0 : g[p.$ref.split("/").pop() ?? ""]) : p,
                        ];
                      })
                      .filter(([b, p]) => p !== void 0),
                  )
      ...
      const f = [],
        ...
        p = (g) => {
          ...
          if (
              ...
              p(
                q === "boolean" || q === "number" || q === "string"
                  ? {
                      ...g,
                      enum:
                        (x = g.enum) != null && x.length && g.enum.filter((P) => P !== null)
                          ? g.enum.filter((P) => typeof P === q)
                          : void 0,
                      type: q,
                    }
                  : q === "integer"
                    ? {
                        ...g,
                        enum:
                          (Q = g.enum) != null && Q.length && g.enum.filter((P) => P !== null)
                            ? g.enum.filter((P) => P !== null && typeof P == "number" && Number.isInteger(P))
                            : void 0,
                        type: q,
                      }
                    : {
            ...
            if ((X = g.enum) != null && X.length && g.enum.filter((q) => q !== null).length)
              for (const q of g.enum.filter((P) => P !== null))
                f.push({
                  const: q,
                  ...g,
                  type: void 0,
...
(function (n) {
  ...
  (n.downgradeComponents = (a) => {
    ...
    (n.downgradeSchema = (a) => (l) => {
                  ...
                  : w.isTuple(f)
                    ? i.push({
                        ...
                        items: (() => {
                          ...
                          const m = [
                            ...f.prefixItems,
                            ...(typeof f.additionalItems == "object" ? [n.downgradeSchema(a)(f.additionalItems)] : []),
                          ];
                          return m.length === 0
                            ? {}
                            : {
      ...
      if ((r(l), d)) for (const f of i) w.isReference(f) ? o(/* @__PURE__ */ new Set())(a)(f) : (f["x-nullable"] = !0);
      return d === !0 && i.length === 0
        ? {
            type: "null",
            ...u,
...
(function (n) {
  (n.capitalize = (e) => (e.length !== 0 ? e[0].toUpperCase() + e.slice(1).toLowerCase() : e)),
    ...
    (n.normalize = (e) => (
      ...
      Xr.has(e) ? `_${e}` : (e.length !== 0 && "0" <= e[0] && e[0] <= "9" && (e = `_${e}`), e)
    )),
    ...
    const h = s(c),
      o = e((y) =>
        y.emendedPath
          ...
          .map(z.normalize)
          .map((_) => (We.variable(_) ? _ : `_${_}`)),
      )(c);
    for (const y of o.values())
      y.entries.forEach((_, a) => {
        _.alias = z.escapeDuplicate(
          [...y.children, ...y.entries.filter((i, u) => a !== u).map((i) => i.alias)].map(z.normalize),
        )(z.normalize(_.alias));
        const l = [
          ..._.route.parameters,
        ...
        l.forEach(
          (i, u) =>
            (i.key = z.escapeDuplicate(["connection", _.alias, ...l.filter((r, f) => u !== f).map((r) => r.key)])(
              i.key,
            )),
        );
...
(function (n) {
  n.compose = (o) => {
    ...
    const [l, d] = ["header", "query"].map((f) => {
              ...
              schema: c({
                ...
                schema: {
                  ...
                  properties: Object.fromEntries([
                    ...new Map(
                      O.map((x) =>
                        Object.entries(x.properties ?? {}).map(([Q, X]) => [
                          Q,
                          {
                            ...X,
      ...
      i = z
        .splitWithNormalization(o.emendedPath)
        .filter((f) => f[0] === ":")
        .map((f) => f.substring(1)),
...
(function (n) {
  (n.execute = async (e) => {
    ...
    if (((s = e.route.success) == null || s.media, t.status !== 200 && t.status !== 201))
      throw new pr(e.route.method.toUpperCase(), e.route.path, t.status, t.headers, t.body);
    return t.body;
  }),
        ...
        ((d = e.route.body) == null ? void 0 : d.type) === "application/x-www-form-urlencoded"
          ...
          : ((i = e.route.body) == null ? void 0 : i.type) === "multipart/form-data"
            ...
            : ((u = e.route.body) == null ? void 0 : u.type) === "application/json"
              ...
              : e.body);
    const h = e.connection.host[e.connection.host.length - 1] !== "/" && e.route.path[0] !== "/" ? `/${Kn(e)}` : Kn(e),
  ...
  (n.shiftArray = (e) => {
    ...
    (n.shiftNumeric = (e) => {
      ...
      return (
        ...
        e.exclusiveMinimum !== void 0 && (t.push(`@exclusiveMinimum ${e.exclusiveMinimum}`), delete e.exclusiveMinimum),
        e.exclusiveMaximum !== void 0 && (t.push(`@exclusiveMaximum ${e.exclusiveMaximum}`), delete e.exclusiveMaximum),
    ...
    (n.shiftString = (e) => {
      ...
      return (
        ...
        e.contentMediaType !== void 0 && (t.push(`@contentMediaType ${e.contentMediaType}`), delete e.contentMediaType),
        e.default !== void 0 && (t.push(`@default ${e.default}`), delete e.default),
        (e.description = Bt({
          description: e.description,
          tags: t,
...
(function (n) {
    ...
    (n.schema = (o) => {
      ...
      const l = (d, i) => {
        ...
        if (w.isReference(d)) {
          ...
          if (
            o.config.reference === !0 ||
            w.isRecursiveReference({
              components: o.components,
              schema: d,
            })
          ) {
          ...
          return r.success === !1
            ...
            : y.push(
                (o.config.constraint ? (f) => f : (f) => de.shiftArray(f))({
                  ...d,
                  items: r.value,
                }),
              );
          ...
          return w.isString(d)
            ? y.push(
                (o.config.constraint ? (r) => r : (r) => de.shiftString(r))({
                  ...d,
                }),
              )
            : w.isNumber(d) || w.isInteger(d)
              ? y.push(
                  (o.config.constraint ? (r) => r : (r) => de.shiftNumeric(r))({
                    ...d,
                  }),
                )
              : w.isTuple(d)
  ...
  const e = (o) =>
      o.predicate(o.schema) === !0
        ? [null, o.schema]
        : D.isUnknown(o.schema) || D.isOneOf(o.schema)
          ? [o.schema, null]
          : D.isObject(o.schema)
            ? s({
                $defs: o.$defs,
    ...
    c = (o) => {
      ...
      if (((d = o.$defs) != null && d[`${y}.Human`]) || ((i = o.$defs) != null && i[`${y}.Llm`]))
        return [
          (u = o.$defs) != null && u[`${y}.Llm`]
            ? {
                ...o.schema,
                $ref: `#/$defs/${y}.Llm`,
              }
            : null,
          (r = o.$defs) != null && r[`${y}.Human`]
            ? {
                ...o.schema,
                $ref: `#/$defs/${y}.Human`,
              }
...
(function (n) {
  ...
  const s = (_) =>
      _.predicate(_.schema) === !0
        ? [null, _.schema]
        : ne.isUnknown(_.schema) || ne.isAnyOf(_.schema)
          ? [_.schema, null]
          : ne.isObject(_.schema)
            ? h({
                $defs: _.$defs,
                predicate: _.predicate,
                schema: _.schema,
    ...
    o = (_) => {
      ...
      if (((u = _.$defs) != null && u[`${a}.Human`]) || ((r = _.$defs) != null && r[`${a}.Llm`]))
        return [
          (f = _.$defs) != null && f[`${a}.Llm`]
            ? {
                ..._.schema,
                $ref: `#/$defs/${a}.Llm`,
              }
            : null,
          (m = _.$defs) != null && m[`${a}.Human`]
            ? {
                ..._.schema,
                $ref: `#/$defs/${a}.Human`,
              }
    ...
    (n.schema = (e) => {
      const t = Oe.schema({
        ...
        validate: (s, c) => {
          ...
          } else if (w.isOneOf(s) && ts(e.components)(s))
            return [
              {
                schema: s,
                accessor: c,
...
const ts = (n) => (e) => {
  const t = [],
    ...
    c = (o) => {
      var y;
      if (w.isBoolean(o) || w.isInteger(o) || w.isNumber(o) || w.isString(o))
        t.push({
          ...o,
        });
...
(function (n) {
  (n.parameters = (e) => ns[e]),
    (n.schema = (e) => rs[e]),
    (n.defaultConfig = (e) => is[e]),
    (n.typeChecker = (e) => as[e]),
    (n.separateParameters = (e) => ss[e]);
})(Ze || (Ze = {}));
const ns = {
...
(function (n) {
  (n.application = (e) => {
    ...
    (n.execute = (e) => ut.execute(e)),
    (n.propagate = (e) => ut.propagate(e)),
    (n.mergeParameters = (e) => lt.parameters(e)),
    (n.mergeValue = (e, t) => lt.value(e, t));
})(yn || (yn = {}));
            ...
            return t(this, function (Z) {
              switch (Z.label) {
                case 0:
                  ...
                  (O = n(n({}, (Mt = m.options) !== null && Mt !== void 0 ? Mt : {}), {
                    method: b.method,
                    headers: (function () {
                      var Ge,
                        Fn,
                    ...
                    p !== void 0 &&
                      (O.body = f.encode(
                        // BODY TRANSFORM
                        ((Ft = b.request) === null || Ft === void 0 ? void 0 : Ft.type) ===
                          "application/x-www-form-urlencoded"
                          ? _(p)
                          : ((Ht = b.request) === null || Ht === void 0 ? void 0 : Ht.type) === "multipart/form-data"
                            ? a(p)
                            : ((Dt = b.request) === null || Dt === void 0 ? void 0 : Dt.type) !== "text/plain"
                              ? (g ?? JSON.stringify)(p)
                              : p,
                        v,
                      )),
                ...
                case 1:
                  return (
                    Z.trys.push([1, 12, 13, 18]),
                    [4, ((Wt = m.fetch) !== null && Wt !== void 0 ? Wt : fetch)(Q.href, O)]
                  );
                case 2:
                  return (
                    (L = Z.sent()),
                    (X.respond_at = /* @__PURE__ */ new Date()),
                    (X.status = L.status),
                    (K = {
                ...
                case 3:
                  if (
                    ...
                    r !== "fetch" && P && P.indexOf("application/json") !== -1)
                  )
                    try {
                ...
                case 5:
                  return ((Ut = b.response) === null || Ut === void 0 ? void 0 : Ut.type) !== "application/json"
                    ? [3, 7]
                    : [4, L.text()];
                case 6:
                  return (Rt = Z.sent()), (K.data = Rt.length ? JSON.parse(Rt) : void 0), [3, 11];
                case 7:
                  return ((Jt = b.response) === null || Jt === void 0 ? void 0 : Jt.type) !==
                    "application/x-www-form-urlencoded"
                    ? [3, 9]
                    : ((Rn = URLSearchParams.bind), [4, L.text()]);
                case 8:
                  return (
                    (At = new (Rn.apply(URLSearchParams, [void 0, Z.sent()]))()),
                    (K.data = b.parseQuery ? b.parseQuery(At) : At),
                    [3, 11]
                  );
                case 9:
...
const lo = /* @__PURE__ */ Object.freeze(
  /* @__PURE__ */ Object.defineProperty(
    {
      __proto__: null,
      get get() {
...
const co = /* @__PURE__ */ Object.freeze(
    /* @__PURE__ */ Object.defineProperty(
      {
        __proto__: null,
        get get() {
...
const mo = /* @__PURE__ */ Object.freeze(
  /* @__PURE__ */ Object.defineProperty(
    {
      __proto__: null,
      get search() {
...
function se(n, e) {
  return (
    (n = n.valueOf()),
    (e = e.valueOf()),
    n instanceof Object ? (n.less instanceof Function ? n.less(e) : ue(n) < ue(e)) : n < e
  );
}
var Y;
(function (n) {
...
function Rr(n, e) {
  for (let t = 0; t < n.length; ++t) (e ^= n.charCodeAt(t)), (e *= $n);
  return Math.abs(e);
}
const vo = 2166136261,
  $n = 16777619;
...
class qn extends qt {
  ...
  erase(e, t = e.next()) {
    ...
    if (e.index() > t.index())
      throw new xo(
        `Error on ${j.get_class_name(this.source())}.erase(): first iterator has greater index than last -> (first = ${e.index()}, last = ${t.index()}).`,
      );
...
class dt extends Ar {
  ...
  swap(e) {
    ([this.data_, e.data_] = [e.data_, this.data_]),
      ee._Swap_associative(this.data_, e.data_),
...
class Nr extends Ir {
  ...
  emplace(e, t) {
    ...
    return !s.equals(this.end()) && this._Key_eq(s.first, e)
      ? new R(s, !1)
      : ((s = this.data_.insert(s, new le(e, t))), this._Handle_insert(s, s.next()), new R(s, !0));
  }
  emplace_hint(e, t, s) {
    const c = new le(t, s);
...
class A extends qn {
  ...
  _Insert_by_range(e, t, s) {
    ...
    if (e.equals(this.end()) === !0)
      ...
      const h = new A();
      h._Reserve(Math.max(c, Math.floor(this.capacity_ * A.MAGNIFIER))),
  ...
  _Insert_to_end(e, t) {
    for (; !e.equals(t); e = e.next()) this._Try_add_row_at_back(), this.matrix_[this.matrix_.length - 1].push(e.value);
  }
  _Try_expand_capacity(e) {
    return e <= this.capacity_
      ? !1
      : ((e = Math.max(e, Math.floor(this.capacity_ * A.MAGNIFIER))), this._Reserve(e), !0);
  }
  _Try_add_row_at_front() {
    const e = this._Compute_col_size();
    return this.matrix_[0].length >= e && this.matrix_.length < A.ROW_SIZE
      ? ((this.matrix_ = [[]].concat(...this.matrix_)), !0)
      : !1;
  }
  _Try_add_row_at_back() {
    const e = this._Compute_col_size();
    return this.matrix_[this.matrix_.length - 1].length >= e && this.matrix_.length < A.ROW_SIZE
      ? (this.matrix_.push([]), !0)
      : !1;
  }
  _Erase_by_range(e, t) {
  ...
  class e {
    ...
    next() {
        ...
        };
      {
        ...
        return (
          ++this.col_ === this.matrix_[this.row_].length && (++this.row_, (this.col_ = 0)),
          {
            done: !1,
            value: s,
          }
...
class In extends qt {
  ...
  _Insert_by_range(e, t, s) {
    ...
    return (
      e.equals(this.begin()) === !0 && (this.begin_ = h), ie._Set_next(c, e), ie._Set_prev(e, c), (this.size_ += o), h
    );
  }
  erase(e, t = e.next()) {
...
class T extends In {
  constructor(...e) {
    if (
      ...
      T.Iterator._Set_source_ptr(this.end_, this.ptr_),
      e.length !== 0)
    )
...
class ke extends Nr {
  ...
  swap(e) {
    ([this.data_, e.data_] = [e.data_, this.data_]),
      ...
      rr._Swap_source(this.tree_, e.tree_),
...
class Ye extends qn {
  ...
  _Set(e, t) {
    ...
    const c = s.prev(),
      h = s.next();
    go(c, this.data_.end()) && c.second === s.second && this.data_.erase(s),
...
class G {
  constructor(...e) {
    if (
      ...
      (this.end_ = G.Iterator.create(this.ptr_, null)),
      (this.before_begin_ = G.Iterator.create(this.ptr_, this.end_)),
      (this.size_ = 0),
      e.length === 1 && e[0] instanceof Array)
    ) {
      const t = e[0];
  ...
  _Insert_by_range(e, t, s) {
    ...
    return (
      G.Iterator._Set_next(c[c.length - 1], e.next()), G.Iterator._Set_next(e, c[0]), (this.size_ += h), c[c.length - 1]
    );
  }
  pop_front() {
  ...
  remove_if(e) {
    ...
    for (let s = this.before_begin(); !s.next().equals(this.end()); s = s.next())
      e(s.next().value) === !0 && (G.Iterator._Set_next(s, s.next().next()), ++t);
    this.size_ -= t;
  }
  merge(e, t = se) {
    if (this === e) return;
...
class mt extends Ar {
  ...
  swap(e) {
    ([this.data_, e.data_] = [e.data_, this.data_]),
      ...
      sr._Swap_source(this.tree_, e.tree_),
      ([this.tree_, e.tree_] = [e.tree_, this.tree_]);
  }
  key_comp() {
    return this.tree_.key_comp();
...
class Xe extends Sr {
  ...
  swap(e) {
    ([this.data_, e.data_] = [e.data_, this.data_]),
      k._Swap_associative(this.data_, e.data_),
      yt._Swap_source(this.buckets_, e.buckets_),
...
class bt extends zr {
  ...
  swap(e) {
    ([this.data_, e.data_] = [e.data_, this.data_]),
      k._Swap_associative(this.data_, e.data_),
      ar._Swap_source(this.tree_, e.tree_),
      ([this.tree_, e.tree_] = [e.tree_, this.tree_]);
  }
  key_comp() {
    return this.tree_.key_comp();
...
class Ae extends Ir {
  ...
  swap(e) {
    ([this.data_, e.data_] = [e.data_, this.data_]),
      I._Swap_associative(this.data_, e.data_),
      pt._Swap_source(this.buckets_, e.buckets_),
      ([this.buckets_, e.buckets_] = [e.buckets_, this.buckets_]);
  }
  find(e) {
    return this.buckets_.find(e);
  ...
  emplace(e, t) {
    ...
    return s.equals(this.end()) === !1
      ? new R(s, !1)
      : (this.data_.push(new le(e, t)), (s = s.prev()), this._Handle_insert(s, s.next()), new R(s, !0));
  }
  emplace_hint(e, t, s) {
    let c = this.find(t);
    return (
      c.equals(this.end()) === !0 && ((c = this.data_.insert(e, new le(t, s))), this._Handle_insert(c, c.next())), c
    );
  }
  _Handle_insert(e, t) {
    for (; !e.equals(t); e = e.next()) this.buckets_.insert(e);
...
class vt extends Mr {
  ...
  swap(e) {
    ([this.data_, e.data_] = [e.data_, this.data_]),
      I._Swap_associative(this.data_, e.data_),
      or._Swap_source(this.tree_, e.tree_),
      ([this.tree_, e.tree_] = [e.tree_, this.tree_]);
  }
  key_comp() {
    return this.tree_.key_comp();
...
class kt {
  constructor(e) {
    (this.provider_ = e),
      (this.driver_ = new Proxy(new ko(), {
        get: ({}, t) => (t === "then" ? null : this._Proxy_func(t)),
      })),
      (this.promises_ = new Ae()),
      (this.join_cv_ = new Po()),
      (this.event_listeners_ = new Ae());
  }
  on(e, t) {
  ...
  async _Send_return(e) {
    ...
    e.return.success === !1 && e.return.value instanceof Error && (e.return.value = Ro(e.return.value)),
...
var V;
(function (n) {
  (n.cp = new _e(() => Ee("child_process"))),
    (n.fs = new _e(() => Ee("fs"))),
    (n.http = new _e(() => Ee("http"))),
    (n.https = new _e(() => Ee("https"))),
    (n.os = new _e(() => Ee("os"))),
    (n.thread = new _e(() => Ee("worker_threads"))),
    (n.ws = new _e(() => import("./browser-CAT76dbF.mjs").then((e) => e.b))),
    (n.process = () => {
  ...
  async connect(e, t = {}) {
    ...
    try {
      ...
      if (
        ...
        this.socket_.send(JSON.stringify(xt.wrap(this.header))),
...
async function Ot(n, e) {
  ...
  await t.connect(`${n.host.endsWith("/") ? n.host.substring(0, n.host.length - 1) : n.host}${Ot.path()}`);
  const s = t.getDriver();
  return {
    connector: t,
    driver: s,
...
const zo = /* @__PURE__ */ Object.freeze(
    /* @__PURE__ */ Object.defineProperty(
      {
        __proto__: null,
        get start() {
...
export { Ho as a, Zr as g, No as i, ms as l };
