  ...
  export function prompt() {
    return {
      ...
      content: [
        ...
        "You should not use 'fillArguments' if you do not yet have enough information to call the function.",
        "You just have to use 'Chat' when you ask a question to the user.",
        "When you use 'fillArguments', the server calls that function and puts the response value of that function back into you.",
